...
export let MessagesPageContainer = class MessagesPageContainer {
    constructor(sb) {
        this.sb = sb;
        this.isCollapsed$ = this.sb.isCollapsed$;
    }
};
MessagesPageContainer = __decorate([
    Component({
    ...
    __metadata('design:paramtypes', [MessagesSandbox])
], MessagesPageContainer);
//# sourceMappingURL=messages-page.container.js.map