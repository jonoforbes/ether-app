...
export let AllActivitiesContainer = class AllActivitiesContainer {
    constructor(sb) {
        this.sb = sb;
...
AllActivitiesContainer = __decorate([
    Component({
    ...
    __metadata('design:paramtypes', [ActivitiesSandbox])
], AllActivitiesContainer);
//# sourceMappingURL=all-activities.container.js.map