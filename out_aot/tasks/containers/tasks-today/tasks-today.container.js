...
export let TasksTodayContainer = class TasksTodayContainer {
    constructor(sb, route, router) {
        this.sb = sb;
        this.route = route;
        this.router = router;
        this.ngUnsubscribe = new Subject();
        this.headerText = "Tasks for Today";
    }
    ngOnDestroy() {
...
TasksTodayContainer = __decorate([
    Component({
...
//# sourceMappingURL=tasks-today.container.js.map