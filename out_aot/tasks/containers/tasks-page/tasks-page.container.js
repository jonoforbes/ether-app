...
export let TasksPageContainer = class TasksPageContainer {
    constructor(sb) {
        this.sb = sb;
        this.isCollapsed$ = this.sb.isCollapsed$;
    }
};
TasksPageContainer = __decorate([
    Component({
        selector: "tasks-page",
    ...
    __metadata('design:paramtypes', [TasksSandbox])
], TasksPageContainer);
//# sourceMappingURL=tasks-page.container.js.map