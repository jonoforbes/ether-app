...
export let ContactsMasterContainer = class ContactsMasterContainer {
    constructor(sb) {
        this.sb = sb;
        this.searchCtrl = new FormControl("");
        this.contacts$ = this.sb.contacts$;
        this.matchingContacts$ = Observable.combineLatest(this.searchCtrl.valueChanges.startWith(""), this.contacts$, (term, contacts) => {
...
ContactsMasterContainer = __decorate([
    Component({
...
//# sourceMappingURL=contacts-master.container.js.map