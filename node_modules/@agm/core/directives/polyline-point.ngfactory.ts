...
import * as import0 from '@agm/core/directives/polyline-point';
import * as import1 from '@angular/core/src/change_detection/change_detection_util';
import * as import2 from '@angular/core/src/linker/view';
import * as import3 from '@angular/core/src/linker/view_utils';
export class Wrapper_AgmPolylinePoint {
  /*private*/ _eventHandler:Function;
  context:import0.AgmPolylinePoint;
  ...
  constructor() {
    this._changed = false;
    this._changes = {};
    this.context = new import0.AgmPolylinePoint();
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean):void {
    ...
    if (emit0) { (this.subscription0 = this.context.positionChanged.subscribe(_eventHandler.bind(view,'positionChanged'))); }
  }
}