...
import * as import0 from './tasks-all.container';
...
export class Wrapper_TasksAllContainer {
  /*private*/ _eventHandler:Function;
  context:import0.TasksAllContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this.context = new import0.TasksAllContainer(p0,p1,p2);
  }
...
const nodeDebugInfos_TasksAllContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.TasksAllContainer],import0.TasksAllContainer,{})];
var renderType_TasksAllContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_TasksAllContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.TasksAllContainer>;
  _TasksAllContainer_0_3:Wrapper_TasksAllContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TasksAllContainer_Host0,renderType_TasksAllContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_TasksAllContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'tasks-all',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_TasksAllContainer0(this.viewUtils,this,0,this._el_0);
    this._TasksAllContainer_0_3 = new Wrapper_TasksAllContainer(this.injectorGet(import9.TasksSandbox,this.parentIndex),this.injectorGet(import10.ActivatedRoute,this.parentIndex),this.injectorGet(import11.Router,this.parentIndex));
    this.compView_0.create(this._TasksAllContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TasksAllContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.TasksAllContainer) && (0 === requestNodeIndex))) { return this._TasksAllContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._TasksAllContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.internalDetectChanges(throwOnChange);
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._TasksAllContainer_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const TasksAllContainerNgFactory:import8.ComponentFactory<import0.TasksAllContainer> = new import8.ComponentFactory<import0.TasksAllContainer>('tasks-all',View_TasksAllContainer_Host0,import0.TasksAllContainer);
const styles_TasksAllContainer:any[] = ([] as any[]);
const nodeDebugInfos_TasksAllContainer0:import2.StaticNodeDebugInfo[] = [
...
export class View_TasksAllContainer0 extends import1.DebugAppView<import0.TasksAllContainer> {
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TasksAllContainer0,renderType_TasksAllContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_TasksAllContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
