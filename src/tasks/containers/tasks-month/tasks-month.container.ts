...
export class TasksMonthContainer implements OnInit {
    private ngUnsubscribe: Subject<void> = new Subject<void>();
    sub: any;
    matchingTasks$: Observable<Array<Task>>;
    headerDate: string;
    headerText: string = "Tasks for This Month";
    ...
    ngOnInit() {
        ...
        let startString: string = startOfMonth.format('Do MMMM YYYY');
        let endString: string = endOfMonth.format('Do MMMM YYYY');
