...
import * as import0 from './tasks-month.container';
...
export class Wrapper_TasksMonthContainer {
  /*private*/ _eventHandler:Function;
  context:import0.TasksMonthContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this.context = new import0.TasksMonthContainer(p0,p1,p2);
  }
...
const nodeDebugInfos_TasksMonthContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.TasksMonthContainer],import0.TasksMonthContainer,{})];
var renderType_TasksMonthContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_TasksMonthContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.TasksMonthContainer>;
  _TasksMonthContainer_0_3:Wrapper_TasksMonthContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TasksMonthContainer_Host0,renderType_TasksMonthContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_TasksMonthContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'tasks-month',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_TasksMonthContainer0(this.viewUtils,this,0,this._el_0);
    this._TasksMonthContainer_0_3 = new Wrapper_TasksMonthContainer(this.injectorGet(import9.TasksSandbox,this.parentIndex),this.injectorGet(import10.ActivatedRoute,this.parentIndex),this.injectorGet(import11.Router,this.parentIndex));
    this.compView_0.create(this._TasksMonthContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TasksMonthContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.TasksMonthContainer) && (0 === requestNodeIndex))) { return this._TasksMonthContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._TasksMonthContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.internalDetectChanges(throwOnChange);
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._TasksMonthContainer_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const TasksMonthContainerNgFactory:import8.ComponentFactory<import0.TasksMonthContainer> = new import8.ComponentFactory<import0.TasksMonthContainer>('tasks-month',View_TasksMonthContainer_Host0,import0.TasksMonthContainer);
const styles_TasksMonthContainer:any[] = ([] as any[]);
const nodeDebugInfos_TasksMonthContainer0:import2.StaticNodeDebugInfo[] = [
...
export class View_TasksMonthContainer0 extends import1.DebugAppView<import0.TasksMonthContainer> {
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TasksMonthContainer0,renderType_TasksMonthContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_TasksMonthContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
