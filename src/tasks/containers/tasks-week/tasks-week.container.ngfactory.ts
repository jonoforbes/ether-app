...
import * as import0 from './tasks-week.container';
...
export class Wrapper_TasksWeekContainer {
  /*private*/ _eventHandler:Function;
  context:import0.TasksWeekContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this.context = new import0.TasksWeekContainer(p0,p1,p2);
  }
...
const nodeDebugInfos_TasksWeekContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.TasksWeekContainer],import0.TasksWeekContainer,{})];
var renderType_TasksWeekContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_TasksWeekContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.TasksWeekContainer>;
  _TasksWeekContainer_0_3:Wrapper_TasksWeekContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TasksWeekContainer_Host0,renderType_TasksWeekContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_TasksWeekContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'tasks-week',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_TasksWeekContainer0(this.viewUtils,this,0,this._el_0);
    this._TasksWeekContainer_0_3 = new Wrapper_TasksWeekContainer(this.injectorGet(import9.TasksSandbox,this.parentIndex),this.injectorGet(import10.ActivatedRoute,this.parentIndex),this.injectorGet(import11.Router,this.parentIndex));
    this.compView_0.create(this._TasksWeekContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TasksWeekContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.TasksWeekContainer) && (0 === requestNodeIndex))) { return this._TasksWeekContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._TasksWeekContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.internalDetectChanges(throwOnChange);
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._TasksWeekContainer_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const TasksWeekContainerNgFactory:import8.ComponentFactory<import0.TasksWeekContainer> = new import8.ComponentFactory<import0.TasksWeekContainer>('tasks-week',View_TasksWeekContainer_Host0,import0.TasksWeekContainer);
const styles_TasksWeekContainer:any[] = ([] as any[]);
const nodeDebugInfos_TasksWeekContainer0:import2.StaticNodeDebugInfo[] = [
...
;
var renderType_TasksWeekContainer:import3.RenderComponentType = import4.createRenderComponentType('/Users/jonoforbes/Developer/Ether/winecellar/src/tasks/containers/tasks-week/tasks-week.container.ts class TasksWeekContainer - inline template',0,import5.ViewEncapsulation.None,styles_TasksWeekContainer,{});
export class View_TasksWeekContainer0 extends import1.DebugAppView<import0.TasksWeekContainer> {
  _text_0:any;
  _el_1:any;
  _text_2:any;
  _el_3:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TasksWeekContainer0,renderType_TasksWeekContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_TasksWeekContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
