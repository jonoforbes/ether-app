...
export class TasksWeekContainer implements OnInit {
    private ngUnsubscribe: Subject<void> = new Subject<void>();
    sub: any;
    matchingTasks$: Observable<Array<Task>>;
    headerDate: string;
    headerText: string = "Tasks for This Week";
    ...
    ngOnInit() {
        ...
        let startString: string = startOfWeek.add(1, 'days').format('Do MMMM YYYY');
        let endString: string = endOfWeek.format('Do MMMM YYYY');
