...
export class TasksNextWeekContainer implements OnInit {
    private ngUnsubscribe: Subject<void> = new Subject<void>();
    sub: any;
    matchingTasks$: Observable<Array<Task>>;
    headerDate: string;
    headerText: string = "Tasks for Next Week";
    ...
    ngOnInit() {
        ...
        let startString: string = startOfNextWeek.add(1, 'days').format('Do MMMM YYYY');
        let endString: string = endOfNextWeek.format('Do MMMM YYYY');
