...
import * as import46 from 'ngx-popover/index';
import * as import47 from 'ng2-date-picker/dp-date-picker.module';
import * as import48 from '../team/index';
...
import * as import70 from 'ng2-date-picker/common/services/dom-appender/dom-appender.service';
import * as import71 from 'ng2-date-picker/common/services/utils/utils.service';
import * as import72 from '../team/services/user-data.service';
import * as import73 from '../team/team.sandbox';
import * as import74 from './services/tasks.service';
import * as import75 from './tasks.sandbox';
...
import * as import81 from '../../node_modules/ngx-popover/PopoverContent.ngfactory';
import * as import82 from '@angular/core/src/i18n/tokens';
import * as import83 from '@angular/material/core/overlay/scroll/scroll-dispatcher';
import * as import84 from '@angular/material/core/overlay/position/viewport-ruler';
import * as import85 from '@angular/material/core/overlay/overlay-container';
import * as import86 from '@angular/core/src/application_ref';
import * as import87 from '@angular/core/src/zone/ng_zone';
import * as import88 from '@angular/material/core/coordination/unique-selection-dispatcher';
import * as import89 from '@angular/material/core/a11y/live-announcer';
import * as import90 from '@angular/material/icon/icon-registry';
import * as import91 from '@angular/platform-browser/src/security/dom_sanitization_service';
import * as import92 from '@angular/material/core/style/focus-classes';
...
import * as import98 from '@angular/flex-layout/media-query/breakpoints/break-points';
class TasksModuleInjector extends import0.NgModuleInjector<import1.TasksModule> {
  ...
  _PopoverModule_45:import46.PopoverModule;
  _DpDatePickerModule_46:import47.DpDatePickerModule;
  _TeamModule_47:import48.TeamModule;
  _TasksModule_48:import1.TasksModule;
  ...
  __DomHelper_81:import70.DomHelper;
  __UtilsService_82:import71.UtilsService;
  __UserDataService_83:import72.UserDataService;
  __TeamSandbox_84:import73.TeamSandbox;
  __TasksService_85:import74.TasksService;
  __TasksSandbox_86:import75.TasksSandbox;
  constructor(parent:import76.Injector) {
    super(parent,[
      ...
      import81.PopoverContentNgFactory
    ]
    ,([] as any[]));
  }
  ...
  get _NgLocalization_51():import51.NgLocaleLocalization {
    if ((this.__NgLocalization_51 == null)) { (this.__NgLocalization_51 = new import51.NgLocaleLocalization(this.parent.get(import82.LOCALE_ID))); }
  ...
  get _ScrollDispatcher_58():any {
    if ((this.__ScrollDispatcher_58 == null)) { (this.__ScrollDispatcher_58 = import83.SCROLL_DISPATCHER_PROVIDER_FACTORY(this.parent.get(import83.ScrollDispatcher,(null as any)))); }
    return this.__ScrollDispatcher_58;
  }
  get _ViewportRuler_59():any {
    if ((this.__ViewportRuler_59 == null)) { (this.__ViewportRuler_59 = import84.VIEWPORT_RULER_PROVIDER_FACTORY(this.parent.get(import84.ViewportRuler,(null as any)),this._ScrollDispatcher_58)); }
    return this.__ViewportRuler_59;
  }
  get _OverlayContainer_60():any {
    if ((this.__OverlayContainer_60 == null)) { (this.__OverlayContainer_60 = import85.OVERLAY_CONTAINER_PROVIDER_FACTORY(this.parent.get(import85.OverlayContainer,(null as any)))); }
  ...
  get _Overlay_62():import57.Overlay {
    if ((this.__Overlay_62 == null)) { (this.__Overlay_62 = new import57.Overlay(this._OverlayContainer_60,this,this._OverlayPositionBuilder_61,this.parent.get(import86.ApplicationRef),this,this.parent.get(import87.NgZone))); }
    return this.__Overlay_62;
  }
  get _UniqueSelectionDispatcher_63():any {
    if ((this.__UniqueSelectionDispatcher_63 == null)) { (this.__UniqueSelectionDispatcher_63 = import88.UNIQUE_SELECTION_DISPATCHER_PROVIDER_FACTORY(this.parent.get(import88.UniqueSelectionDispatcher,(null as any)))); }
  ...
  get _LiveAnnouncer_66():any {
    if ((this.__LiveAnnouncer_66 == null)) { (this.__LiveAnnouncer_66 = import89.LIVE_ANNOUNCER_PROVIDER_FACTORY(this.parent.get(import89.LiveAnnouncer,(null as any)),this.parent.get(import89.LIVE_ANNOUNCER_ELEMENT_TOKEN,(null as any)))); }
  ...
  get _MdIconRegistry_68():any {
    if ((this.__MdIconRegistry_68 == null)) { (this.__MdIconRegistry_68 = import23.ICON_REGISTRY_PROVIDER_FACTORY(this.parent.get(import90.MdIconRegistry,(null as any)),this._Http_57,this.parent.get(import91.DomSanitizer))); }
  ...
  get _FocusOriginMonitor_71():any {
    if ((this.__FocusOriginMonitor_71 == null)) { (this.__FocusOriginMonitor_71 = import92.FOCUS_ORIGIN_MONITOR_PROVIDER_FACTORY(this.parent.get(import92.FocusOriginMonitor,(null as any)))); }
  ...
  get _MatchMedia_73():import63.MatchMedia {
    if ((this.__MatchMedia_73 == null)) { (this.__MatchMedia_73 = new import63.MatchMedia(this.parent.get(import87.NgZone))); }
  ...
  get _CommonSandbox_78():import67.CommonSandbox {
    if ((this.__CommonSandbox_78 == null)) { (this.__CommonSandbox_78 = new import67.CommonSandbox(this.parent.get(import93.Store))); }
    return this.__CommonSandbox_78;
  }
  get _AuthenticatedGuard_79():import68.AuthenticatedGuard {
    if ((this.__AuthenticatedGuard_79 == null)) { (this.__AuthenticatedGuard_79 = new import68.AuthenticatedGuard(this.parent.get(import94.Router))); }
    return this.__AuthenticatedGuard_79;
  }
  get _RealTime_80():import69.RealTime {
    if ((this.__RealTime_80 == null)) { (this.__RealTime_80 = new import69.RealTime(this.parent.get(import93.Store))); }
    return this.__RealTime_80;
  }
  get _DomHelper_81():import70.DomHelper {
    if ((this.__DomHelper_81 == null)) { (this.__DomHelper_81 = new import70.DomHelper()); }
    return this.__DomHelper_81;
  }
  get _UtilsService_82():import71.UtilsService {
    if ((this.__UtilsService_82 == null)) { (this.__UtilsService_82 = new import71.UtilsService()); }
    return this.__UtilsService_82;
  }
  get _UserDataService_83():import72.UserDataService {
    if ((this.__UserDataService_83 == null)) { (this.__UserDataService_83 = new import72.UserDataService(this.parent.get(import93.Store),this._Http_57)); }
    return this.__UserDataService_83;
  }
  get _TeamSandbox_84():import73.TeamSandbox {
    if ((this.__TeamSandbox_84 == null)) { (this.__TeamSandbox_84 = new import73.TeamSandbox(this.parent.get(import93.Store),this._UserDataService_83)); }
    return this.__TeamSandbox_84;
  }
  get _TasksService_85():import74.TasksService {
    if ((this.__TasksService_85 == null)) { (this.__TasksService_85 = new import74.TasksService(this.parent.get(import93.Store),this._Http_57)); }
    return this.__TasksService_85;
  }
  get _TasksSandbox_86():import75.TasksSandbox {
    if ((this.__TasksSandbox_86 == null)) { (this.__TasksSandbox_86 = new import75.TasksSandbox(this.parent.get(import93.Store),this._TasksService_85)); }
    return this.__TasksSandbox_86;
  }
  createInternal():import1.TasksModule {
    ...
    this._PopoverModule_45 = new import46.PopoverModule();
    this._DpDatePickerModule_46 = new import47.DpDatePickerModule();
    this._TeamModule_47 = new import48.TeamModule();
    this._TasksModule_48 = new import1.TasksModule();
    return this._TasksModule_48;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import46.PopoverModule)) { return this._PopoverModule_45; }
    if ((token === import47.DpDatePickerModule)) { return this._DpDatePickerModule_46; }
    if ((token === import48.TeamModule)) { return this._TeamModule_47; }
    if ((token === import1.TasksModule)) { return this._TasksModule_48; }
    ...
    if ((token === import95.XSRFStrategy)) { return this._XSRFStrategy_54; }
    if ((token === import54.XHRBackend)) { return this._XHRBackend_55; }
    if ((token === import55.RequestOptions)) { return this._RequestOptions_56; }
    if ((token === import96.Http)) { return this._Http_57; }
    if ((token === import83.ScrollDispatcher)) { return this._ScrollDispatcher_58; }
    if ((token === import84.ViewportRuler)) { return this._ViewportRuler_59; }
    if ((token === import85.OverlayContainer)) { return this._OverlayContainer_60; }
    ...
    if ((token === import88.UniqueSelectionDispatcher)) { return this._UniqueSelectionDispatcher_63; }
    ...
    if ((token === import89.LiveAnnouncer)) { return this._LiveAnnouncer_66; }
    if ((token === import60.MdDialog)) { return this._MdDialog_67; }
    if ((token === import90.MdIconRegistry)) { return this._MdIconRegistry_68; }
    if ((token === import97.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_69; }
    if ((token === import62.MdSnackBar)) { return this._MdSnackBar_70; }
    if ((token === import92.FocusOriginMonitor)) { return this._FocusOriginMonitor_71; }
    if ((token === import41.DomProjection)) { return this._DomProjection_72; }
    if ((token === import63.MatchMedia)) { return this._MatchMedia_73; }
    if ((token === import98.BREAKPOINTS)) { return this._BREAKPOINTS_74; }
    ...
    if ((token === import70.DomHelper)) { return this._DomHelper_81; }
    if ((token === import71.UtilsService)) { return this._UtilsService_82; }
    if ((token === import72.UserDataService)) { return this._UserDataService_83; }
    if ((token === import73.TeamSandbox)) { return this._TeamSandbox_84; }
    if ((token === import74.TasksService)) { return this._TasksService_85; }
    if ((token === import75.TasksSandbox)) { return this._TasksSandbox_86; }
    return notFoundResult;
  }
  destroyInternal():void {
  }
}
export const TasksModuleNgFactory:import0.NgModuleFactory<import1.TasksModule> = new import0.NgModuleFactory(TasksModuleInjector,import1.TasksModule);