...
import * as import0 from './client-accounts-master.container';
...
export class Wrapper_ClientAccountsMasterContainer {
  /*private*/ _eventHandler:Function;
  context:import0.ClientAccountsMasterContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.ClientAccountsMasterContainer(p0);
  }
...
const nodeDebugInfos_ClientAccountsMasterContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.ClientAccountsMasterContainer],import0.ClientAccountsMasterContainer,{})];
var renderType_ClientAccountsMasterContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_ClientAccountsMasterContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.ClientAccountsMasterContainer>;
  _ClientAccountsMasterContainer_0_3:Wrapper_ClientAccountsMasterContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ClientAccountsMasterContainer_Host0,renderType_ClientAccountsMasterContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_ClientAccountsMasterContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'client-accounts-master',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_ClientAccountsMasterContainer0(this.viewUtils,this,0,this._el_0);
    this._ClientAccountsMasterContainer_0_3 = new Wrapper_ClientAccountsMasterContainer(this.injectorGet(import9.ClientAccountsSandbox,this.parentIndex));
    this.compView_0.create(this._ClientAccountsMasterContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._ClientAccountsMasterContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.ClientAccountsMasterContainer) && (0 === requestNodeIndex))) { return this._ClientAccountsMasterContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._ClientAccountsMasterContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const ClientAccountsMasterContainerNgFactory:import8.ComponentFactory<import0.ClientAccountsMasterContainer> = new import8.ComponentFactory<import0.ClientAccountsMasterContainer>('client-accounts-master',View_ClientAccountsMasterContainer_Host0,import0.ClientAccountsMasterContainer);
const styles_ClientAccountsMasterContainer:any[] = ([] as any[]);
const nodeDebugInfos_ClientAccountsMasterContainer0:import2.StaticNodeDebugInfo[] = [
  ...
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo([import19.ClientAccountsMasterListComponent],import19.ClientAccountsMasterListComponent,{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{})
]
;
var renderType_ClientAccountsMasterContainer:import3.RenderComponentType = import4.createRenderComponentType('/Users/jonoforbes/Developer/Ether/winecellar/src/client-accounts/containers/client-accounts-master/client-accounts-master.container.ts class ClientAccountsMasterContainer - inline template',0,import5.ViewEncapsulation.None,styles_ClientAccountsMasterContainer,{});
export class View_ClientAccountsMasterContainer0 extends import1.DebugAppView<import0.ClientAccountsMasterContainer> {
  _text_0:any;
  _el_1:any;
  ...
  _text_9:any;
  _el_10:any;
  compView_10:import1.AppView<import19.ClientAccountsMasterListComponent>;
  _ClientAccountsMasterListComponent_10_3:import28.Wrapper_ClientAccountsMasterListComponent;
  _text_11:any;
  _pipe_async_0:import29.AsyncPipe;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ClientAccountsMasterContainer0,renderType_ClientAccountsMasterContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_ClientAccountsMasterContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_3 = import4.createRenderElement(this.renderer,(null as any),'input',new import4.InlineArray8(6,'mdInput','','placeholder','Search Accounts','style','width: 120px; margin-top: -10px; margin-left: 5px; color: #838383 !important;'),this.debug(3,3,8));
    ...
    this._el_10 = import4.createRenderElement(this.renderer,parentRenderNode,'client-accounts-master-list',import4.EMPTY_INLINE_ARRAY,this.debug(10,7,8));
    this.compView_10 = new import28.View_ClientAccountsMasterListComponent0(this.viewUtils,this,10,this._el_10);
    this._ClientAccountsMasterListComponent_10_3 = new import28.Wrapper_ClientAccountsMasterListComponent(this.parentView.injectorGet(import32.Router,this.parentIndex));
    this.compView_10.create(this._ClientAccountsMasterListComponent_10_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.ClientAccountsMasterListComponent) && (10 === requestNodeIndex))) { return this._ClientAccountsMasterListComponent_10_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.debug(3,3,23);
    const currVal_3_2_0:any = 'Search Accounts';
    ...
    this.debug(10,7,37);
    valUnwrapper.reset();
    const currVal_10_0_0:any = valUnwrapper.unwrap(this._pipe_async_0.transform(this.context.matchingClientAccounts$));
    this._ClientAccountsMasterListComponent_10_3.check_clientAccounts(currVal_10_0_0,throwOnChange,valUnwrapper.hasWrappedValue);
    if (this._ClientAccountsMasterListComponent_10_3.ngDoCheck(this,this._el_10,throwOnChange)) { this.compView_10.markAsCheckOnce(); }
    if (!throwOnChange) {
