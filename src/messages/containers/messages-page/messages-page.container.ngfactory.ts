...
import * as import0 from './messages-page.container';
...
export class Wrapper_MessagesPageContainer {
  /*private*/ _eventHandler:Function;
  context:import0.MessagesPageContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.MessagesPageContainer(p0);
  }
...
const nodeDebugInfos_MessagesPageContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.MessagesPageContainer],import0.MessagesPageContainer,{})];
var renderType_MessagesPageContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_MessagesPageContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.MessagesPageContainer>;
  _MessagesPageContainer_0_3:Wrapper_MessagesPageContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MessagesPageContainer_Host0,renderType_MessagesPageContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_MessagesPageContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'messages-page',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_MessagesPageContainer0(this.viewUtils,this,0,this._el_0);
    this._MessagesPageContainer_0_3 = new Wrapper_MessagesPageContainer(this.injectorGet(import9.MessagesSandbox,this.parentIndex));
    this.compView_0.create(this._MessagesPageContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._MessagesPageContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.MessagesPageContainer) && (0 === requestNodeIndex))) { return this._MessagesPageContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._MessagesPageContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const MessagesPageContainerNgFactory:import8.ComponentFactory<import0.MessagesPageContainer> = new import8.ComponentFactory<import0.MessagesPageContainer>('messages-page',View_MessagesPageContainer_Host0,import0.MessagesPageContainer);
const styles_MessagesPageContainer:any[] = ([] as any[]);
const nodeDebugInfos_MessagesPageContainer0:import2.StaticNodeDebugInfo[] = [
...
export class View_MessagesPageContainer0 extends import1.DebugAppView<import0.MessagesPageContainer> {
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MessagesPageContainer0,renderType_MessagesPageContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_MessagesPageContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
