...
import * as import0 from './messages-master.container';
...
import * as import9 from '../../../team/team.sandbox';
...
export class Wrapper_MessagesMasterContainer {
  /*private*/ _eventHandler:Function;
  context:import0.MessagesMasterContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.MessagesMasterContainer(p0);
  }
...
const nodeDebugInfos_MessagesMasterContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.MessagesMasterContainer],import0.MessagesMasterContainer,{})];
var renderType_MessagesMasterContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_MessagesMasterContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.MessagesMasterContainer>;
  _MessagesMasterContainer_0_3:Wrapper_MessagesMasterContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MessagesMasterContainer_Host0,renderType_MessagesMasterContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_MessagesMasterContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'messages-master',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_MessagesMasterContainer0(this.viewUtils,this,0,this._el_0);
    this._MessagesMasterContainer_0_3 = new Wrapper_MessagesMasterContainer(this.injectorGet(import9.TeamSandbox,this.parentIndex));
    this.compView_0.create(this._MessagesMasterContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._MessagesMasterContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.MessagesMasterContainer) && (0 === requestNodeIndex))) { return this._MessagesMasterContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._MessagesMasterContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const MessagesMasterContainerNgFactory:import8.ComponentFactory<import0.MessagesMasterContainer> = new import8.ComponentFactory<import0.MessagesMasterContainer>('messages-master',View_MessagesMasterContainer_Host0,import0.MessagesMasterContainer);
const styles_MessagesMasterContainer:any[] = ([] as any[]);
const nodeDebugInfos_MessagesMasterContainer0:import2.StaticNodeDebugInfo[] = [
  ...
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo([import19.MessagesMasterListComponent],import19.MessagesMasterListComponent,{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{})
]
;
...
export class View_MessagesMasterContainer0 extends import1.DebugAppView<import0.MessagesMasterContainer> {
  ...
  _text_9:any;
  _el_10:any;
  compView_10:import1.AppView<import19.MessagesMasterListComponent>;
  _MessagesMasterListComponent_10_3:import28.Wrapper_MessagesMasterListComponent;
  _text_11:any;
  _pipe_async_0:import29.AsyncPipe;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_MessagesMasterContainer0,renderType_MessagesMasterContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_MessagesMasterContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_3 = import4.createRenderElement(this.renderer,(null as any),'input',new import4.InlineArray8(6,'mdInput','','placeholder','Search Messages','style','width: 120px; margin-top: -10px; margin-left: 5px; color: #838383 !important;'),this.debug(3,3,8));
    ...
    this._el_10 = import4.createRenderElement(this.renderer,parentRenderNode,'messages-master-list',import4.EMPTY_INLINE_ARRAY,this.debug(10,7,8));
    this.compView_10 = new import28.View_MessagesMasterListComponent0(this.viewUtils,this,10,this._el_10);
    this._MessagesMasterListComponent_10_3 = new import28.Wrapper_MessagesMasterListComponent(this.parentView.injectorGet(import32.Router,this.parentIndex));
    this.compView_10.create(this._MessagesMasterListComponent_10_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.MessagesMasterListComponent) && (10 === requestNodeIndex))) { return this._MessagesMasterListComponent_10_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.debug(3,3,23);
    const currVal_3_2_0:any = 'Search Messages';
    ...
    this._MessagesMasterListComponent_10_3.check_team(currVal_10_0_0,throwOnChange,valUnwrapper.hasWrappedValue);
    if (this._MessagesMasterListComponent_10_3.ngDoCheck(this,this._el_10,throwOnChange)) { this.compView_10.markAsCheckOnce(); }
    if (!throwOnChange) {
