...
import * as import0 from './client-documents-page.container';
...
export class Wrapper_ClientDocumentsPageContainer {
  /*private*/ _eventHandler:Function;
  context:import0.ClientDocumentsPageContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.ClientDocumentsPageContainer(p0);
  }
...
const nodeDebugInfos_ClientDocumentsPageContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.ClientDocumentsPageContainer],import0.ClientDocumentsPageContainer,{})];
var renderType_ClientDocumentsPageContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_ClientDocumentsPageContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.ClientDocumentsPageContainer>;
  _ClientDocumentsPageContainer_0_3:Wrapper_ClientDocumentsPageContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ClientDocumentsPageContainer_Host0,renderType_ClientDocumentsPageContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_ClientDocumentsPageContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'client-documents-page',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_ClientDocumentsPageContainer0(this.viewUtils,this,0,this._el_0);
    this._ClientDocumentsPageContainer_0_3 = new Wrapper_ClientDocumentsPageContainer(this.injectorGet(import9.ClientDocumentsSandbox,this.parentIndex));
    this.compView_0.create(this._ClientDocumentsPageContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._ClientDocumentsPageContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.ClientDocumentsPageContainer) && (0 === requestNodeIndex))) { return this._ClientDocumentsPageContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    this._ClientDocumentsPageContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange);
...
export const ClientDocumentsPageContainerNgFactory:import8.ComponentFactory<import0.ClientDocumentsPageContainer> = new import8.ComponentFactory<import0.ClientDocumentsPageContainer>('client-documents-page',View_ClientDocumentsPageContainer_Host0,import0.ClientDocumentsPageContainer);
const styles_ClientDocumentsPageContainer:any[] = ([] as any[]);
const nodeDebugInfos_ClientDocumentsPageContainer0:import2.StaticNodeDebugInfo[] = [
...
;
var renderType_ClientDocumentsPageContainer:import3.RenderComponentType = import4.createRenderComponentType('/Users/jonoforbes/Developer/Ether/winecellar/src/client-documents/containers/client-documents-page/client-documents-page.container.ts class ClientDocumentsPageContainer - inline template',0,import5.ViewEncapsulation.None,styles_ClientDocumentsPageContainer,{});
export class View_ClientDocumentsPageContainer0 extends import1.DebugAppView<import0.ClientDocumentsPageContainer> {
  _text_0:any;
  _el_1:any;
  _text_2:any;
  _el_3:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ClientDocumentsPageContainer0,renderType_ClientDocumentsPageContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_ClientDocumentsPageContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_5 = import4.createRenderElement(this.renderer,(null as any),'md-sidenav',new import4.InlineArray8(8,'align','start','class','left-sidenav','mode','side','tabIndex','-1'),this.debug(5,4,16));
