...
import * as import0 from './team-page.container';
...
export class Wrapper_TeamPageContainer {
  /*private*/ _eventHandler:Function;
  context:import0.TeamPageContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.TeamPageContainer(p0);
  }
...
const nodeDebugInfos_TeamPageContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.TeamPageContainer],import0.TeamPageContainer,{})];
var renderType_TeamPageContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_TeamPageContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.TeamPageContainer>;
  _TeamPageContainer_0_3:Wrapper_TeamPageContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TeamPageContainer_Host0,renderType_TeamPageContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_TeamPageContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'team-page',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_TeamPageContainer0(this.viewUtils,this,0,this._el_0);
    this._TeamPageContainer_0_3 = new Wrapper_TeamPageContainer(this.injectorGet(import9.TeamSandbox,this.parentIndex));
    this.compView_0.create(this._TeamPageContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TeamPageContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.TeamPageContainer) && (0 === requestNodeIndex))) { return this._TeamPageContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._TeamPageContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const TeamPageContainerNgFactory:import8.ComponentFactory<import0.TeamPageContainer> = new import8.ComponentFactory<import0.TeamPageContainer>('team-page',View_TeamPageContainer_Host0,import0.TeamPageContainer);
const styles_TeamPageContainer:any[] = ([] as any[]);
const nodeDebugInfos_TeamPageContainer0:import2.StaticNodeDebugInfo[] = [
...
export class View_TeamPageContainer0 extends import1.DebugAppView<import0.TeamPageContainer> {
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TeamPageContainer0,renderType_TeamPageContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_TeamPageContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
