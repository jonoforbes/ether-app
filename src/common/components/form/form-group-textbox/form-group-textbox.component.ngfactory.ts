...
import * as import0 from './form-group-textbox.component';
...
export class Wrapper_FormGroupTextbox {
  /*private*/ _eventHandler:Function;
  context:import0.FormGroupTextbox;
  ...
  constructor() {
    this._changed = false;
    this.context = new import0.FormGroupTextbox();
...
const nodeDebugInfos_FormGroupTextbox_Host0:import4.StaticNodeDebugInfo[] = [new import4.StaticNodeDebugInfo([import0.FormGroupTextbox],import0.FormGroupTextbox,{})];
var renderType_FormGroupTextbox_Host:import5.RenderComponentType = import3.createRenderComponentType('',0,import6.ViewEncapsulation.None,([] as any[]),{});
class View_FormGroupTextbox_Host0 extends import2.DebugAppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.FormGroupTextbox>;
  _FormGroupTextbox_0_3:Wrapper_FormGroupTextbox;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_FormGroupTextbox_Host0,renderType_FormGroupTextbox_Host,import7.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_FormGroupTextbox_Host0);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'form-group-textbox',import3.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_FormGroupTextbox0(this.viewUtils,this,0,this._el_0);
    this._FormGroupTextbox_0_3 = new Wrapper_FormGroupTextbox();
    this.compView_0.create(this._FormGroupTextbox_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import9.ComponentRef_<any>(0,this,this._el_0,this._FormGroupTextbox_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.FormGroupTextbox) && (0 === requestNodeIndex))) { return this._FormGroupTextbox_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._FormGroupTextbox_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const FormGroupTextboxNgFactory:import9.ComponentFactory<import0.FormGroupTextbox> = new import9.ComponentFactory<import0.FormGroupTextbox>('form-group-textbox',View_FormGroupTextbox_Host0,import0.FormGroupTextbox);
const styles_FormGroupTextbox:any[] = ([] as any[]);
const nodeDebugInfos_FormGroupTextbox1:import4.StaticNodeDebugInfo[] = [new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{})];
class View_FormGroupTextbox1 extends import2.DebugAppView<any> {
  _el_0:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_FormGroupTextbox1,renderType_FormGroupTextbox,import7.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_FormGroupTextbox1,declaredViewContainer);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
...
const nodeDebugInfos_FormGroupTextbox0:import4.StaticNodeDebugInfo[] = [
...
;
var renderType_FormGroupTextbox:import5.RenderComponentType = import3.createRenderComponentType('/Users/jonoforbes/Developer/Ether/ether-app/src/common/components/form/form-group-textbox/form-group-textbox.component.ts class FormGroupTextbox - inline template',0,import6.ViewEncapsulation.None,styles_FormGroupTextbox,{});
export class View_FormGroupTextbox0 extends import2.DebugAppView<import0.FormGroupTextbox> {
  _text_0:any;
  _el_1:any;
  _text_2:any;
  _el_3:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_FormGroupTextbox0,renderType_FormGroupTextbox,import7.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_FormGroupTextbox0);
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._el_8 = import3.createRenderElement(this.renderer,this._el_6,'input',new import3.InlineArray4(4,'class','form-control input-lg','type','text'),this.debug(8,4,16));
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 10)) { return new View_FormGroupTextbox1(this.viewUtils,this,10,this._anchor_10,this._vc_10); }
    return (null as any);
  }
