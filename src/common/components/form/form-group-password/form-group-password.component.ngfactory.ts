...
import * as import0 from './form-group-password.component';
...
export class Wrapper_FormGroupPassword {
  /*private*/ _eventHandler:Function;
  context:import0.FormGroupPassword;
  ...
  constructor() {
    this._changed = false;
    this.context = new import0.FormGroupPassword();
...
const nodeDebugInfos_FormGroupPassword_Host0:import4.StaticNodeDebugInfo[] = [new import4.StaticNodeDebugInfo([import0.FormGroupPassword],import0.FormGroupPassword,{})];
var renderType_FormGroupPassword_Host:import5.RenderComponentType = import3.createRenderComponentType('',0,import6.ViewEncapsulation.None,([] as any[]),{});
class View_FormGroupPassword_Host0 extends import2.DebugAppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.FormGroupPassword>;
  _FormGroupPassword_0_3:Wrapper_FormGroupPassword;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_FormGroupPassword_Host0,renderType_FormGroupPassword_Host,import7.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_FormGroupPassword_Host0);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'form-group-password',import3.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_FormGroupPassword0(this.viewUtils,this,0,this._el_0);
    this._FormGroupPassword_0_3 = new Wrapper_FormGroupPassword();
    this.compView_0.create(this._FormGroupPassword_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import9.ComponentRef_<any>(0,this,this._el_0,this._FormGroupPassword_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.FormGroupPassword) && (0 === requestNodeIndex))) { return this._FormGroupPassword_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._FormGroupPassword_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const FormGroupPasswordNgFactory:import9.ComponentFactory<import0.FormGroupPassword> = new import9.ComponentFactory<import0.FormGroupPassword>('form-group-password',View_FormGroupPassword_Host0,import0.FormGroupPassword);
const styles_FormGroupPassword:any[] = ([] as any[]);
const nodeDebugInfos_FormGroupPassword1:import4.StaticNodeDebugInfo[] = [new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{})];
class View_FormGroupPassword1 extends import2.DebugAppView<any> {
  _el_0:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_FormGroupPassword1,renderType_FormGroupPassword,import7.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_FormGroupPassword1,declaredViewContainer);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
...
const nodeDebugInfos_FormGroupPassword0:import4.StaticNodeDebugInfo[] = [
...
export class View_FormGroupPassword0 extends import2.DebugAppView<import0.FormGroupPassword> {
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_FormGroupPassword0,renderType_FormGroupPassword,import7.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_FormGroupPassword0);
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._el_3 = import3.createRenderElement(this.renderer,this._el_1,'label',new import3.InlineArray2(2,'class','col-sm-4 control-label'),this.debug(3,2,13));
    this._text_4 = this.renderer.createText(this._el_3,'',this.debug(4,2,51));
    ...
    this._el_8 = import3.createRenderElement(this.renderer,this._el_6,'input',new import3.InlineArray4(4,'class','form-control input-lg','type','password'),this.debug(8,4,16));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.debug(10,8,26);
    const currVal_10_0_0:any = this.context.control.valid;
    ...
    this.debug(1,1,45);
    const currVal_22:any = this.context.control.valid;
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 10)) { return new View_FormGroupPassword1(this.viewUtils,this,10,this._anchor_10,this._vc_10); }
    return (null as any);
  }
