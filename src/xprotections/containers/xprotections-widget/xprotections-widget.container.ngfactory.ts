...
import * as import0 from './xprotections-widget.container';
...
import * as import10 from '../../xprotections.sandbox';
...
import * as import15 from '../../components/xprotection-tab/xprotection-tab.component';
...
import * as import20 from '../../components/xprotection-tab/xprotection-tab.component.ngfactory';
import * as import21 from '@angular/forms/src/form_builder';
import * as import22 from '@angular/material/tabs/tab-group';
import * as import23 from '../../components/add-xprotection-tab/add-xprotection-tab.component';
...
import * as import27 from '../../components/add-xprotection-tab/add-xprotection-tab.component.ngfactory';
...
export class Wrapper_XProtectionsWidgetContainer {
  /*private*/ _eventHandler:Function;
  context:import0.XProtectionsWidgetContainer;
  ...
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.XProtectionsWidgetContainer(p0,p1,p2);
  ...
  check_xProtectionOwnerType(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_0,currValue))) {
      this._changed = true;
      this.context.xProtectionOwnerType = currValue;
      this._changes['xProtectionOwnerType'] = new import1.SimpleChange(this._expr_0,currValue);
      this._expr_0 = currValue;
    }
  }
  check_xProtectionContactId(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_1,currValue))) {
      this._changed = true;
      this.context.xProtectionContactId = currValue;
      this._changes['xProtectionContactId'] = new import1.SimpleChange(this._expr_1,currValue);
...
const nodeDebugInfos_XProtectionsWidgetContainer_Host0:import4.StaticNodeDebugInfo[] = [new import4.StaticNodeDebugInfo([import0.XProtectionsWidgetContainer],import0.XProtectionsWidgetContainer,{})];
var renderType_XProtectionsWidgetContainer_Host:import5.RenderComponentType = import3.createRenderComponentType('',0,import6.ViewEncapsulation.None,([] as any[]),{});
class View_XProtectionsWidgetContainer_Host0 extends import2.DebugAppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.XProtectionsWidgetContainer>;
  _XProtectionsWidgetContainer_0_3:Wrapper_XProtectionsWidgetContainer;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_XProtectionsWidgetContainer_Host0,renderType_XProtectionsWidgetContainer_Host,import7.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_XProtectionsWidgetContainer_Host0);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'xprotections-widget',import3.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_XProtectionsWidgetContainer0(this.viewUtils,this,0,this._el_0);
    this._XProtectionsWidgetContainer_0_3 = new Wrapper_XProtectionsWidgetContainer(this.injectorGet(import10.XProtectionsSandbox,this.parentIndex),this.injectorGet(import11.ActivatedRoute,this.parentIndex),this.injectorGet(import12.Router,this.parentIndex));
    this.compView_0.create(this._XProtectionsWidgetContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import9.ComponentRef_<any>(0,this,this._el_0,this._XProtectionsWidgetContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.XProtectionsWidgetContainer) && (0 === requestNodeIndex))) { return this._XProtectionsWidgetContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._XProtectionsWidgetContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    this.compView_0.internalDetectChanges(throwOnChange);
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._XProtectionsWidgetContainer_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const XProtectionsWidgetContainerNgFactory:import9.ComponentFactory<import0.XProtectionsWidgetContainer> = new import9.ComponentFactory<import0.XProtectionsWidgetContainer>('xprotections-widget',View_XProtectionsWidgetContainer_Host0,import0.XProtectionsWidgetContainer);
const styles_XProtectionsWidgetContainer:any[] = ([] as any[]);
const nodeDebugInfos_XProtectionsWidgetContainer1:import4.StaticNodeDebugInfo[] = [
  ...
  new import4.StaticNodeDebugInfo([import15.XProtectionTabComponent],import15.XProtectionTabComponent,{}),
  new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{})
]
;
class View_XProtectionsWidgetContainer1 extends import2.DebugAppView<any> {
  _el_0:any;
  ...
  _text_1:any;
  _el_2:any;
  compView_2:import2.AppView<import15.XProtectionTabComponent>;
  _XProtectionTabComponent_2_3:import20.Wrapper_XProtectionTabComponent;
  _text_3:any;
  _el_4:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import16.ViewContainer) {
    super(View_XProtectionsWidgetContainer1,renderType_XProtectionsWidgetContainer,import7.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_XProtectionsWidgetContainer1,declaredViewContainer);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._el_2 = import3.createRenderElement(this.renderer,(null as any),'xprotection-tab',import3.EMPTY_INLINE_ARRAY,this.debug(2,7,12));
    this.compView_2 = new import20.View_XProtectionTabComponent0(this.viewUtils,this,2,this._el_2);
    this._XProtectionTabComponent_2_3 = new import20.Wrapper_XProtectionTabComponent(this.parentView.parentView.injectorGet(import21.FormBuilder,this.parentView.parentIndex));
    this.compView_2.create(this._XProtectionTabComponent_2_3.context);
    ...
    var disposable_0:Function = import3.subscribeToRenderElement(this,this._el_2,new import3.InlineArray2(2,'updateXProtection',(null as any)),this.eventHandler(this.handleEvent_2));
    this._XProtectionTabComponent_2_3.subscribe(this,this.eventHandler(this.handleEvent_2),true);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import15.XProtectionTabComponent) && (2 === requestNodeIndex))) { return this._XProtectionTabComponent_2_3.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._XProtectionTabComponent_2_3.check_xProtection(currVal_2_0_0,throwOnChange,false);
    if (this._XProtectionTabComponent_2_3.ngDoCheck(this,this._el_2,throwOnChange)) { this.compView_2.markAsCheckOnce(); }
    this._vc_0.detectChangesInNestedViews(throwOnChange);
    this.compView_0.internalDetectChanges(throwOnChange);
    this.compView_2.internalDetectChanges(throwOnChange);
  }
  dirtyParentQueriesInternal():void {
    (<View_XProtectionsWidgetContainer0>this.parentView)._query_MdTab_1_0.setDirty();
  }
  destroyInternal():void {
    this._vc_0.destroyNestedViews();
    this.compView_0.destroy();
    this.compView_2.destroy();
    this._XProtectionTabComponent_2_3.ngOnDestroy();
    this.debug(2,7,12);
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
  ...
  handleEvent_2(eventName:string,$event:any):boolean {
    ...
    var result:boolean = true;
    if ((eventName == 'updateXProtection')) {
...
const nodeDebugInfos_XProtectionsWidgetContainer0:import4.StaticNodeDebugInfo[] = [
  new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import4.StaticNodeDebugInfo([
    import13.MdPrefixRejector,
    import22.MdTabGroup
  ...
  ,import14.MdTab,{}),
  new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import4.StaticNodeDebugInfo([import23.AddXProtectionTabComponent],import23.AddXProtectionTabComponent,{}),
  new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import4.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import4.StaticNodeDebugInfo([
...
export class View_XProtectionsWidgetContainer0 extends import2.DebugAppView<import0.XProtectionsWidgetContainer> {
  ...
  _text_4:any;
  _el_5:any;
  compView_5:import2.AppView<import23.AddXProtectionTabComponent>;
  _AddXProtectionTabComponent_5_3:import27.Wrapper_AddXProtectionTabComponent;
  _text_6:any;
  _text_7:any;
  _anchor_8:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_XProtectionsWidgetContainer0,renderType_XProtectionsWidgetContainer,import7.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_XProtectionsWidgetContainer0);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._el_5 = import3.createRenderElement(this.renderer,(null as any),'add-xprotection-tab',import3.EMPTY_INLINE_ARRAY,this.debug(5,4,8));
    this.compView_5 = new import27.View_AddXProtectionTabComponent0(this.viewUtils,this,5,this._el_5);
    this._AddXProtectionTabComponent_5_3 = new import27.Wrapper_AddXProtectionTabComponent(this.parentView.injectorGet(import21.FormBuilder,this.parentIndex));
    this.compView_5.create(this._AddXProtectionTabComponent_5_3.context);
    ...
    var disposable_0:Function = import3.subscribeToRenderElement(this,this._el_5,new import3.InlineArray2(2,'addXProtection',(null as any)),this.eventHandler(this.handleEvent_5));
    this._AddXProtectionTabComponent_5_3.subscribe(this,this.eventHandler(this.handleEvent_5),true);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import23.AddXProtectionTabComponent) && (5 === requestNodeIndex))) { return this._AddXProtectionTabComponent_5_3.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.debug(5,4,8);
    if (this._AddXProtectionTabComponent_5_3.ngDoCheck(this,this._el_5,throwOnChange)) { this.compView_5.markAsCheckOnce(); }
    this.debug(8,6,16);
    valUnwrapper.reset();
    const currVal_8_0_0:any = valUnwrapper.unwrap(this._pipe_async_0.transform(this.context.xProtections$));
    ...
    if (!throwOnChange) {
      if (this._query_MdTab_1_0.dirty) {
        this._query_MdTab_1_0.reset([
          ...
          this._vc_8.mapNestedViews(View_XProtectionsWidgetContainer1,(nestedView:View_XProtectionsWidgetContainer1):any => {
  ...
  destroyInternal():void {
    ...
    this._AddXProtectionTabComponent_5_3.ngOnDestroy();
    this.debug(5,4,8);
    this.debug(3,3,8);
    this.debug(8,6,8);
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 8)) { return new View_XProtectionsWidgetContainer1(this.viewUtils,this,8,this._anchor_8,this._vc_8); }
    return (null as any);
  }
