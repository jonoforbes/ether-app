...
export const routes = [
    ...
    // { path: "calendar", component: CalendarPageContainer, canActivate: [AuthenticatedGuard], children: [
    //     { path: "list", component: CalendarMasterContainer, outlet: 'm'},
    //     { path: "add", component: CalendarDetailContainer, outlet: 'd'},
    //     { path: ":id", component: CalendarDetailContainer, outlet: 'd'}
    // ]},
