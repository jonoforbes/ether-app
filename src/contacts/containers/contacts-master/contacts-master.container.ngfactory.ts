...
import * as import0 from './contacts-master.container';
...
export class Wrapper_ContactsMasterContainer {
  /*private*/ _eventHandler:Function;
  context:import0.ContactsMasterContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.ContactsMasterContainer(p0);
  }
...
const nodeDebugInfos_ContactsMasterContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.ContactsMasterContainer],import0.ContactsMasterContainer,{})];
var renderType_ContactsMasterContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_ContactsMasterContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.ContactsMasterContainer>;
  _ContactsMasterContainer_0_3:Wrapper_ContactsMasterContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ContactsMasterContainer_Host0,renderType_ContactsMasterContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_ContactsMasterContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this.compView_0 = new View_ContactsMasterContainer0(this.viewUtils,this,0,this._el_0);
    this._ContactsMasterContainer_0_3 = new Wrapper_ContactsMasterContainer(this.injectorGet(import9.ContactsSandbox,this.parentIndex));
    this.compView_0.create(this._ContactsMasterContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._ContactsMasterContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.ContactsMasterContainer) && (0 === requestNodeIndex))) { return this._ContactsMasterContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._ContactsMasterContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const ContactsMasterContainerNgFactory:import8.ComponentFactory<import0.ContactsMasterContainer> = new import8.ComponentFactory<import0.ContactsMasterContainer>('contacts-master',View_ContactsMasterContainer_Host0,import0.ContactsMasterContainer);
const styles_ContactsMasterContainer:any[] = ([] as any[]);
const nodeDebugInfos_ContactsMasterContainer0:import2.StaticNodeDebugInfo[] = [
  ...
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo([import19.ContactsMasterListComponent],import19.ContactsMasterListComponent,{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{}),
  new import2.StaticNodeDebugInfo(([] as any[]),(null as any),{})
]
;
...
export class View_ContactsMasterContainer0 extends import1.DebugAppView<import0.ContactsMasterContainer> {
  ...
  _text_9:any;
  _el_10:any;
  compView_10:import1.AppView<import19.ContactsMasterListComponent>;
  _ContactsMasterListComponent_10_3:import28.Wrapper_ContactsMasterListComponent;
  _text_11:any;
  _text_12:any;
  _pipe_async_0:import29.AsyncPipe;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ContactsMasterContainer0,renderType_ContactsMasterContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_ContactsMasterContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_3 = import4.createRenderElement(this.renderer,(null as any),'input',new import4.InlineArray8(6,'mdInput','','placeholder','Search Contacts','style','width: 120px; margin-top: -10px; margin-left: 5px; color: #838383 !important;'),this.debug(3,3,8));
    ...
    this._el_10 = import4.createRenderElement(this.renderer,parentRenderNode,'contacts-master-list',import4.EMPTY_INLINE_ARRAY,this.debug(10,7,8));
    this.compView_10 = new import28.View_ContactsMasterListComponent0(this.viewUtils,this,10,this._el_10);
    this._ContactsMasterListComponent_10_3 = new import28.Wrapper_ContactsMasterListComponent(this.parentView.injectorGet(import32.Router,this.parentIndex));
    this._text_11 = this.renderer.createText((null as any),'\n        ',this.debug(11,9,51));
    this.compView_10.create(this._ContactsMasterListComponent_10_3.context);
    ...
    var disposable_3:Function = import4.subscribeToRenderElement(this,this._el_10,new import4.InlineArray2(2,'updateClientAccount',(null as any)),this.eventHandler(this.handleEvent_10));
    this._ContactsMasterListComponent_10_3.subscribe(this,this.eventHandler(this.handleEvent_10),true);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.ContactsMasterListComponent) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._ContactsMasterListComponent_10_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this.debug(3,3,23);
    const currVal_3_2_0:any = 'Search Contacts';
    ...
    this.debug(10,9,12);
    valUnwrapper.reset();
    const currVal_10_0_0:any = valUnwrapper.unwrap(this._pipe_async_0.transform(this.context.matchingContacts$));
    this._ContactsMasterListComponent_10_3.check_contacts(currVal_10_0_0,throwOnChange,valUnwrapper.hasWrappedValue);
    if (this._ContactsMasterListComponent_10_3.ngDoCheck(this,this._el_10,throwOnChange)) { this.compView_10.markAsCheckOnce(); }
    if (!throwOnChange) {
  ...
  destroyInternal():void {
    ...
    this.debug(5,4,8);
    this.debug(1,2,8);
    this._ContactsMasterListComponent_10_3.ngOnDestroy();
    this.debug(10,7,8);
