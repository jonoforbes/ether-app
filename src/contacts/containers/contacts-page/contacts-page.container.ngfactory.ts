...
import * as import0 from './contacts-page.container';
...
export class Wrapper_ContactsPageContainer {
  /*private*/ _eventHandler:Function;
  context:import0.ContactsPageContainer;
  /*private*/ _changed:boolean;
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.ContactsPageContainer(p0);
  }
...
const nodeDebugInfos_ContactsPageContainer_Host0:import2.StaticNodeDebugInfo[] = [new import2.StaticNodeDebugInfo([import0.ContactsPageContainer],import0.ContactsPageContainer,{})];
var renderType_ContactsPageContainer_Host:import3.RenderComponentType = import4.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_ContactsPageContainer_Host0 extends import1.DebugAppView<any> {
  _el_0:any;
  compView_0:import1.AppView<import0.ContactsPageContainer>;
  _ContactsPageContainer_0_3:Wrapper_ContactsPageContainer;
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ContactsPageContainer_Host0,renderType_ContactsPageContainer_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,nodeDebugInfos_ContactsPageContainer_Host0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer,'contacts-page',import4.EMPTY_INLINE_ARRAY,rootSelector,this.debug(0,0,0));
    this.compView_0 = new View_ContactsPageContainer0(this.viewUtils,this,0,this._el_0);
    this._ContactsPageContainer_0_3 = new Wrapper_ContactsPageContainer(this.injectorGet(import9.ContactsSandbox,this.parentIndex));
    this.compView_0.create(this._ContactsPageContainer_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._ContactsPageContainer_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.ContactsPageContainer) && (0 === requestNodeIndex))) { return this._ContactsPageContainer_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.debug(0,0,0);
    if (this._ContactsPageContainer_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
...
export const ContactsPageContainerNgFactory:import8.ComponentFactory<import0.ContactsPageContainer> = new import8.ComponentFactory<import0.ContactsPageContainer>('contacts-page',View_ContactsPageContainer_Host0,import0.ContactsPageContainer);
const styles_ContactsPageContainer:any[] = ([] as any[]);
const nodeDebugInfos_ContactsPageContainer0:import2.StaticNodeDebugInfo[] = [
...
;
var renderType_ContactsPageContainer:import3.RenderComponentType = import4.createRenderComponentType('/Users/jonoforbes/Developer/Ether/winecellar/src/contacts/containers/contacts-page/contacts-page.container.ts class ContactsPageContainer - inline template',0,import5.ViewEncapsulation.None,styles_ContactsPageContainer,{});
export class View_ContactsPageContainer0 extends import1.DebugAppView<import0.ContactsPageContainer> {
  _text_0:any;
  _el_1:any;
  _text_2:any;
  _el_3:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ContactsPageContainer0,renderType_ContactsPageContainer,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckOnce,nodeDebugInfos_ContactsPageContainer0);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n        \n        ',this.debug(0,0,0));
    this._el_1 = import4.createRenderElement(this.renderer,parentRenderNode,'div',new import4.InlineArray2(2,'style','height: 100vh !important'),this.debug(1,2,8));
